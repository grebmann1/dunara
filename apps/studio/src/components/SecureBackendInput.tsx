...
export function SecureBackendInput({ base, environment, input, disabled, rememberAvailable, onSaved, compact = false }: { base: string; environment: EnvironmentName; input: SecretVersion; disabled: boolean; rememberAvailable: boolean; onSaved: () => Promise<unknown>; compact?: boolean }) {
