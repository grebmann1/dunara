...
const buttonVariants = cva('inline-flex min-h-[var(--control-size)] min-w-[var(--control-size)] shrink-0 items-center justify-center gap-2 rounded-lg border border-solid px-3 py-1.5 text-sm font-medium leading-5 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0', {
  variants: {
    variant: {
