...
try {
  ...
  console.log('PASS: actual Electron service settings, environment-over-file precedence, encrypted restart persistence, renderer isolation and simulated EPIPE recovery. No provider calls or user-app changes.');
